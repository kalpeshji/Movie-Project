...
var upload = multer({ storage: storage }).single('movieImage')
...
app.get('/movies', async function (req, res) {
    ...
    res.render('../View/Pages/Movie', { movie: movie })
})
app.get('/add', (req, res) => {
    res.render("../View/Pages/Add")
})
...
app.get('/edit/:id', async function (req, res) {
    ...
    res.render('../View/Pages/Edit', { movie: result })
})
